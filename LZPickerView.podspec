...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "LLZ"
  # s.authors            = { "LLZ" => "lvboyv@sohu.com" }
  # s.social_media_url   = "http://twitter.com/LLZ"
  ...
  # s.resource  = "LZPickerView.xib"
  s.resources = "LZPickerView/LZPickerView.xib"
